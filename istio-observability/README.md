...
![Querying on Prometheus to get Istio generated metrics.](img/doc_istio-obervability_0.jpeg)
...
![Tracing microservices on Jaeger](img/doc_istio-obervability_5.png)
...
![Below is an example of Access logs](img/doc_istio-obervability_9.png)
...
![Envoy Proxy metrics showed on Prometheus Metrics Explorer](img/doc_istio-obervability_1.jpeg)
* Querying on Prometheus to get Envoy server uptime in hours
![Querying on Prometheus to get Envoy server uptime in hours](img/doc_istio-obervability_2.jpeg)
...
![Querying on Prometheus to get average request duration in milisecond from "productpage" to any destinations except "unknown" every 1 minute. ](img/doc_istio-obervability_3.jpeg)
...
![Querying on Prometheus to get a number of success sidecar injection requests.](img/doc_istio-obervability_4.jpeg)
...
![Tracing 1 request to "productpage" with Jaeger.](img/doc_istio-obervability_6.png)
...
![Tracing 1 request to "productpage" with Zipkin.](img/doc_istio-obervability_7.png)

* Tracing "productpage" dependencies with Zipkin.
![Tracing "productpage" dependencies with Zipkin.](img/doc_istio-obervability_8.png)
...
![Logging access logs on envoy proxy at "productpage" service](img/doc_istio-obervability_9.png)

* Logging access logs on envoy proxy at "reviews" service.
![Logging access logs on envoy proxy at "reviews" service.](img/doc_istio-obervability_10.png)
